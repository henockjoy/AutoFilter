...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1824857814').split()]
...
MULTI_CLIENT = False
name = str(environ.get('name', 'Filmotainment'))
